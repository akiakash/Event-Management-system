...
function VehicleUpdate() {
  ...
  const [vehicleManagement, setVehicleManagement] = useState([]);
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/VehicleManagement/${id}`)
      .then((response) => {
        console.log(response.data);
        setVehicleManagement(response.data);
        ...
        setChildSeat(response.data.ChildSeat);
  ...
  function UpdateCleaningCompany() {
    ...
    //   });
    axios
      .patch(`http://localhost:3000/VehicleManagement/${id}`, {
        category: category,
        Model: Model,
        CarNumber: CarNumber,
        colour: colour,
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.category}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Model}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.CarNumber}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.colour}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Driver}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Seat}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.ChildSeat}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Gps}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Price}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={vehicleManagement.Description}
