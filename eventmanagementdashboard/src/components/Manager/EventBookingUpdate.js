...
function EventBookingUpdate() {
  ...
  const clientEventBooking = JSON.parse(
    window.sessionStorage.getItem("clientEventBooking")
  );

  console.log("clientEventBooking : ", clientEventBooking);
  ...
  function UpdateCleaningCompany() {
    setLoading(true);
    axios
      .patch(`http://localhost:3000/EventBooking/${clientEventBooking._id}`, {
        Status: Status,
      })
      .then((response) => {
        setLoading(false);
                  ...
                  <Form>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientEventBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientEventBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientEventBooking.Status}
...
export default EventBookingUpdate;
