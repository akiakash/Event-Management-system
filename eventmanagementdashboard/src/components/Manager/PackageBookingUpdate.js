...
function PackageBookingUpdate() {
  const [loading, setLoading] = useState(false);
  const [Status, setStatus] = useState([]);

  const clientPackageBooking = JSON.parse(
    window.sessionStorage.getItem("clientPackageBooking")
  );

  console.log("clientPackageBooking : ", clientPackageBooking);
  ...
  function UpdateCleaningCompany() {
    ...
    axios
      .patch(
        `http://localhost:3000/PackageBooking/${clientPackageBooking._id}`,
        {
          Status: Status,
        }
      )
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.PackageName}
                          disabled
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.PackagePrice}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.Contactnumber}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.Email}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientPackageBooking.Status}
...
export default PackageBookingUpdate;
