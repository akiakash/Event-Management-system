...
function VehicleBookingUpdate() {
  const [loading, setLoading] = useState(false);
  const [Status, setStatus] = useState([]);

  const clientVehicleBooking = JSON.parse(
    window.sessionStorage.getItem("clientVehicleBooking")
  );

  console.log("clientVehicleBooking : ", clientVehicleBooking);
  ...
  function UpdateCleaningCompany() {
    ...
    axios
      .patch(
        `http://localhost:3000/VehicleBooking/${clientVehicleBooking._id}`,
        {
          Status: Status,
        }
      )
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.VegicleCategory}
                          disabled
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.VehicleModel}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.NoOfDays}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.Contactnumber}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.Email}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.Price}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientVehicleBooking.Status}
...
export default VehicleBookingUpdate;
