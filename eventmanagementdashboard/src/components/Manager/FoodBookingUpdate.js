...
function FoodBookingUpdate() {
  const [loading, setLoading] = useState(false);
  const [Status, setStatus] = useState([]);

  const clientFoodBooking = JSON.parse(
    window.sessionStorage.getItem("clientFoodBooking")
  );

  console.log("clientFoodBooking : ", clientFoodBooking);
  ...
  function UpdateCleaningCompany() {
    setLoading(true);
    axios
      .patch(`http://localhost:3000/FoodsBooking/${clientFoodBooking._id}`, {
        Status: Status,
      })
      .then((response) => {
        setLoading(false);
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.FoodName}
                          disabled
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.Quantity}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.Price}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.ContactNumber}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.EMail}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientFoodBooking.Status}
...
export default FoodBookingUpdate;
