...
function HotelBookingUpdate() {
  const [loading, setLoading] = useState(false);
  const [Status, setStatus] = useState([]);

  const clientHotelBooking = JSON.parse(
    window.sessionStorage.getItem("clientHotelBooking")
  );

  console.log("clientHotelBooking : ", clientHotelBooking);
  ...
  function UpdateCleaningCompany() {
    setLoading(true);
    axios
      .patch(`http://localhost:3000/HotelBooking/${clientHotelBooking._id}`, {
        Status: Status,
      })
      .then((response) => {
        setLoading(false);
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.HotelName}
                          disabled
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.TotalMembers}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.NoOfChild}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.NoOfBed}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.AC}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.Price}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientHotelBooking.Status}
...
export default HotelBookingUpdate;
