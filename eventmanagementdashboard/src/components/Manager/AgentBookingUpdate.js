...
function AgentBookingUpdate() {
  const [loading, setLoading] = useState(false);
  const [Status, setStatus] = useState([]);

  const clientAgentBooking = JSON.parse(
    window.sessionStorage.getItem("clientAgentBooking")
  );

  console.log("clientAgentBooking : ", clientAgentBooking);
  ...
  function UpdateCleaningCompany() {
    setLoading(true);
    axios
      .patch(`http://localhost:3000/AgentBooking/${clientAgentBooking._id}`, {
        Status: Status,
      })
      .then((response) => {
        setLoading(false);
                  ...
                  <Form>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.AgentFirstName}
                          disabled
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.AgentLastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.FirstName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.LastName}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.ContactNumber}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.EMail}
                          disabled
                        />
                      </Col>
                    </Form.Group>
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={clientAgentBooking.Status}
...
export default AgentBookingUpdate;
